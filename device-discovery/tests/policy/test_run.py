...
class TestRunStore:
    ...
    def test_max_runs_per_target(self):
    ...
    def test_update_run_failure(self):
    ...
    def test_normalize_target_hostname(self):
    ...
    def test_normalize_target_cidr(self):
    ...
    def test_get_runs_for_policy_sorted(self):
    ...
    def test_get_runs_for_nonexistent_policy(self):
    ...
    def test_get_runs_for_nonexistent_target(self):
    ...
    def test_get_all_policies_with_runs(self):
    ...
    def test_deep_copy_returned(self):
    ...
    def test_thread_safety_create(self):
    ...
    def test_multiple_policies_isolated(self):
