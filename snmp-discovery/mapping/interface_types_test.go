...
var tests = []struct {
	...
	{
		name:                 "ethernetCsmacd 2.5Gbps",
		ifType:               "6",
		defaultInterfaceType: "",
		expectedNetboxType:   "2.5gbase-t",
		description:          "ethernetCsmacd with 2.5Gbps should map to 2.5gbase-t",
		speed:                int64Ptr(2500000),
	},
	{
	...
	{
		name:                 "ethernetCsmacd 40Gbps",
		ifType:               "6",
		defaultInterfaceType: "",
		expectedNetboxType:   "40gbase-x-qsfpp",
		description:          "ethernetCsmacd with 40Gbps should map to 40gbase-x-qsfpp",
		speed:                int64Ptr(40000000),
	},
	{
		name:                 "ethernetCsmacd 100Gbps",
		ifType:               "6",
		defaultInterfaceType: "",
		expectedNetboxType:   "100gbase-x-qsfp28",
		description:          "ethernetCsmacd with 100Gbps should map to 100gbase-x-qsfp28",
		speed:                int64Ptr(100000000),
	},
	{
		name:                 "ethernetCsmacd 200Gbps",
		ifType:               "6",
		defaultInterfaceType: "",
		expectedNetboxType:   "200gbase-x-qsfp56",
		description:          "ethernetCsmacd with 200Gbps should map to 200gbase-x-qsfp56",
		speed:                int64Ptr(200000000),
	},
	{
		name:                 "ethernetCsmacd 400Gbps",
		ifType:               "6",
		defaultInterfaceType: "",
		expectedNetboxType:   "400gbase-x-qsfpdd",
		description:          "ethernetCsmacd with 400Gbps should map to 400gbase-x-qsfpdd",
		speed:                int64Ptr(400000000),
	},
	{
		name:                 "ethernetCsmacd 800Gbps",
		ifType:               "6",
		defaultInterfaceType: "",
		expectedNetboxType:   "800gbase-x-qsfpdd",
		description:          "ethernetCsmacd with 800Gbps should map to 800gbase-x-qsfpdd",
		speed:                int64Ptr(800000000),
	},
	{
	...
	},
	{
		...
		ifType:               "6",
		defaultInterfaceType: "",
		expectedNetboxType:   "5gbase-t",
		description:          "ethernetCsmacd with 5Gbps should map to 5gbase-t",
	...
	},
	{
		...
		ifType:               "6",
		defaultInterfaceType: "",
		expectedNetboxType:   "50gbase-x-sfp56",
		description:          "ethernetCsmacd with 50Gbps should map to 50gbase-x-sfp56",
	...
	// Edge cases
	{
		name:                 "ethernetCsmacd with default and no speed",
		ifType:               "6",
		defaultInterfaceType: "custom-type",
		expectedNetboxType:   "custom-type",
		description:          "ethernetCsmacd should use default type when speed is missing",
	},
	{
		name:                 "ethernetCsmacd above max speed",
		ifType:               "6",
		defaultInterfaceType: "",
		expectedNetboxType:   "other",
		description:          "ethernetCsmacd with >800Gbps should map to other",
		speed:                int64Ptr(900000000),
	},
	{
