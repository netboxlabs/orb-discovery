...
var InterfaceTypeMap = map[int]string{
	// Virtual Interfaces
	...
	181: "other-wireless", // propDocsWirelessDownstream
	182: "other-wireless", // propDocsWirelessUpstream
...
func isEthernetInterfaceType(ifType int) bool {
...
func getEthernetInterfaceType(speed uint) string {
	if speed <= 10000 {
		return "10base-t"
	}
	if speed <= 100000 {
...
func GetNetboxType(ifType int, defaultInterfaceType string, speed uint) string {
