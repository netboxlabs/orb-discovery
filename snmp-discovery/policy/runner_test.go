...
func TestNewRunner(t *testing.T) {
	...
	// Create new runner
	_, err := policy.NewRunner(ctx, logger, "test-policy", policyConfig, mockClient, snmp.NewFakeSNMPWalker, &mappingConfig, nil)
...
func TestRunnerRun(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			...
			// Create runner
			runner, err := policy.NewRunner(ctx, logger, "test-policy", policyConfig, mockClient, snmp.NewFakeSNMPWalker, &mappingConfig, nil)
			assert.NoError(t, err, "policy.NewRunner should not return an error")
...
func TestRunnerWalkError(t *testing.T) {
	...
	runner, err := policy.NewRunner(ctx, logger, "test-policy", policyConfig, mockClient, mockClientFactory, &mappingConfig, nil)
	assert.NoError(t, err)
