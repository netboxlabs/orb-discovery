...
from orb_discovery.cli.cli import main, run_driver, start_agent, start_policy
from orb_discovery.parser import DiscoveryConfig, Napalm, Policy
...
def mock_parse_args():
    ...
    """
    with patch("orb_discovery.cli.cli.argparse.ArgumentParser.parse_args") as mock:
        yield mock
...
def mock_load_dotenv():
    ...
    """
    with patch("orb_discovery.cli.cli.load_dotenv") as mock:
        yield mock
...
def mock_parse_config_file():
    ...
    """
    with patch("orb_discovery.cli.cli.parse_config_file") as mock:
        yield mock
...
def mock_start_agent():
    ...
    """
    with patch("orb_discovery.cli.cli.start_agent") as mock:
        yield mock
...
def mock_client():
    ...
    """
    with patch("orb_discovery.cli.cli.Client") as mock:
        yield mock
...
def mock_thread_pool_executor():
    ...
    """
    with patch("orb_discovery.cli.cli.ThreadPoolExecutor") as mock:
        yield mock
...
def mock_as_completed():
    ...
    """
    with patch("orb_discovery.cli.cli.as_completed") as mock:
        yield mock
